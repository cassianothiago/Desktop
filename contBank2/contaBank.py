...
class Mainwindow(QMainWindow):
    def __init__(self):
        ...
        self.depButton.clicked.connect(self.saldo_depositar)
        
        #linha para digitar o valor dep apos abertura da conta
        self.valor_Qline=QLineEdit(self)
        self.totalvalor=self.valorDepInicial_Qline
    ...
    def saldo_depositar(self):
        self.valor_saldo=Saldo()
        self.valor_saldo.depositar(int(self.totalvalor.text()),int(self.totaldep.text()))
        self.valor_Qlabel.setText('Saldo = R$ {},00'.format(self.valor_saldo))
